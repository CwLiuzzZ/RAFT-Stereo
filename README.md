...
python evaluate_stereo.py --restore_ckpt models/raftstereo-middlebury.pth
python evaluate_stereo.py --restore_ckpt models/raftstereo-realtime.pth
python evaluate_stereo.py --restore_ckpt models/raftstereo-sceneflow.pth

python evaluate_stereo.py --data_type middlebury
python evaluate_stereo.py --data_type real_road
python evaluate_stereo.py --data_type virtualroad_seed
python evaluate_stereo.py --data_type real_road_seed
python evaluate_stereo.py --data_type real_road_seed
nohup python -u evaluate_stereo.py --data_type real_road_seed > nohup.out 2>&1 & 
nohup python -u evaluate_stereo.py --data_type virtualroad_seed > nohup.out 2>&1 & 
nohup python -u evaluate_stereo.py --data_type real_road_seed > nohup.out 2>&1 & 

python train_stereo.py --mixed_precision
python train_stereo.py --mixed_precision --data_type middlebury
python train_stereo.py --mixed_precision --data_type apollo

nohup python -u train_stereo.py --restore_ckpt models/raftstereo-eth3d.pth --mixed_precision > nohup.out 2>&1 & 
nohup python -u train_stereo.py --data_type middlebury --mixed_precision > nohup.out 2>&1 & 
